...
static int nandll_read_page (uchar *buf, ulong addr, int large_block)
{
	...
	NFCMMD 0x70200008 NAND Flash √¸¡Ó…Ë÷√ºƒ¥Ê∆˜0
	...
	*/
	...
	NFSTAT 0x70200028 NAND Flash ≤Ÿ◊˜◊¥Ã¨ºƒ¥Ê∆˜
	*/
...
#define NFCONT_OFFSET 0x04
	...
	NFCONT 0x70200004 ∂¡/–¥NAND Flash øÿ÷∆ºƒ¥Ê∆˜
	[0]1£∫NAND Flash øÿ÷∆∆˜ πƒ‹
	*/
...
#define NFADDR_OFFSET 0x0C
	...
	NFADDR 0x7020000C NAND Flash µÿ÷∑…Ë÷√ºƒ¥Ê∆˜
	*/
...
#define __REGb(x) (*(vu_char *)(x))
	...
	NFDATA 0x70200010 ∂¡/–¥NAND Flash  ˝æ›ºƒ¥Ê∆˜
	NAND Flash ∂¡/…’–¥ ˝æ›÷µ”√”⁄I/O
	*/
